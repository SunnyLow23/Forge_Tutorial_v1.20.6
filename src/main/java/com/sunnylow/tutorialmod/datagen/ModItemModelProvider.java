...
public class ModItemModelProvider extends ItemModelProvider {
	...
	private ItemModelBuilder simpleItem(RegistryObject<Item> object) {
		return withExistingParent(object.getId().getPath(),
				new ResourceLocation("item/generated")).texture("layer0",
				new ResourceLocation(TutorialMod.MOD_ID, "item/" + object.getId().getPath()));
	}

	public void evenSimplerBlockItem(RegistryObject<Block> block) {
		this.withExistingParent(
				TutorialMod.MOD_ID + ":" + ForgeRegistries.BLOCKS.getKey(block.get()).getPath(),
	...
	private ItemModelBuilder simpleBlockItem(RegistryObject<Block> object) {
		return withExistingParent(object.getId().getPath(),
				new ResourceLocation("item/generated")).texture("layer0",
				new ResourceLocation(TutorialMod.MOD_ID, "item/" + object.getId().getPath()));
	}
